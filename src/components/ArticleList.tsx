        ...
        <section className="w-full">
            <div className="space-y-10">
                {articles.map((article, index) => (
                    <article
                        key={index}
                        className="group relative rounded-xl border border-zinc-700 p-6 hover:border-zinc-500 transition-all duration-200"
                    >
                        <p className="text-sm text-zinc-500">{article.date}</p>
                        <h2 className="mt-2 text-lg font-semibold text-white group-hover:text-indigo-400 transition">
                            {article.title}
                        </h2>
