...
const projects: Project[] = [
    {
        title: 'A$AP',
        description:
            'Mein persönlicher Blog mit Stil.',
    ...
    },
    {
        ...
        description:
            'Die offizielle Seite des TSV Calw Basketball.',
...
export default function ProjectsPage() {
    return (
        <main className="max-w-5xl mx-auto px-4 py-24 grid grid-cols-1 lg:grid-cols-3 gap-12 text-zinc-300">
            ...
            {/* Headline + Intro (links, 2 Spalten) */}
            <div className="lg:col-span-2 space-y-6">
                ...
                <p>
                    ...
                    auf die ich besonders stolz bin. Viele davon sind Open Source. Wenn
                    dich etwas anspricht, schau dir den Code an und bring dich gerne mit Ideen ein.
                </p>
            </div>

            {/* Project Grid (volle Breite unten) */}
