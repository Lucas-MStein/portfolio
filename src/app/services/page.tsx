...
const services: Service[] = [
    {
        ...
        points: ['SSR/ISR, API Routes, Routing', 'Saubere Komponenten & State-Management', 'Responsive & Dark Mode'],
        Icon: Code2,
    },
    {
        title: 'UI/UX & Implementierung',
        description: 'Vom Wireframe zum fertigen Interface – pixelgenau und wartbar umgesetzt.',
        points: ['Design-Systeme & Komponentenbibliotheken', 'Interaktionen/Animationen (Framer Motion)', 'Saubere Typografie & Layout'],
        Icon: Layout,
    },
    {
        title: 'Performance & Qualität',
        description: 'Ladezeiten senken, Core Web Vitals verbessern, Bugs eliminieren.',
        points: ['Lighthouse/Pagespeed-Audits', 'Code-Splitting & Caching', 'Monitoring & Error Tracking'],
        Icon: Gauge,
    },
    {
        title: 'SEO & Sichtbarkeit',
        description: 'Technische SEO, Metadaten/OG, Sitemaps – damit Inhalte gefunden werden.',
        points: ['Meta/OG, strukturierte Daten', 'Saubere URL-Struktur & Redirects', 'Indexierung & Robots'],
        Icon: Search,
    },
    {
        title: 'Wartung & Weiterentwicklung',
        description: 'Regelmäßige Updates, Security-Patches und neue Features nach Bedarf.',
        points: ['Abhängigkeits-Updates', 'Refactoring & Tests', 'Roadmap & Iteration'],
        Icon: Wrench,
    },
    {
        title: 'Launch & Deployment',
        description: 'Vercel/Netlify-Setups, Domains, Preview-Workflows & CI/CD.',
        points: ['Automatisches Deployment', 'Preview-Environments', 'Domain & SSL'],
        Icon: Rocket,
    },
];
        ...
        <main className="bg-black text-white min-h-screen py-20">
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <PageHeader
                    ...
                    description="Von der Idee bis zum Go-Live: Ich plane, baue und betreue Websites und Web-Apps, die schnell, zugänglich und gut wartbar sind. Transparent, pragmatisch und mit Liebe zum Detail."
                />
